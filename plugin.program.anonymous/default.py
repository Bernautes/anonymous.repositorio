...
def index():
	...
	if HIDESPACERS == 'No': addFile('[COLOR yellow][B][Install Menu][/B][/COLOR]                                        ', '', themeit=THEME3)
	addDir ('Apk Apps' ,'apk', icon=ICONAPK, themeit=THEME1)
	if HIDESPACERS == 'No': addFile('[COLOR yellow][B][Settings Menu][/B][/COLOR]                                        ', '', themeit=THEME3)
	...
	if HIDESPACERS == 'No': addFile('[COLOR yellow][B][Wizard Configuration][/B][/COLOR]                                        ', '', themeit=THEME3)
	addFile('Settings'      ,'settings', icon=ICONSETTINGS, themeit=THEME1)
	addFile('Auto Clean: %s' % autoclean.replace('true',on).replace('false',off) ,'togglesetting', 'autoclean',   icon=ICONMAINT, themeit=THEME1)
...
def maintMenu():
	...
	cache      = 'true' if AUTOCACHE     == 'true' else 'false'
	packages   = 'true' if AUTOPACKAGES  == 'true' else 'false'
	addFile('[COLOR yellow][B][Primary][/B][/COLOR]', '', themeit=THEME3)
	addFile('  [COLOR red][B]Fresh Start[/B][/COLOR]'       ,'freshstart',      icon=ICONMAINT, themeit=THEME1)
	...
	addFile('  Delete Thumbnails'                     ,'clearthumb',      icon=ICONMAINT, themeit=THEME1)
	addFile('  Purge Databases'                      ,'purgedb',         icon=ICONMAINT, themeit=THEME1)
	addFile('[COLOR yellow][B][Logs][/B][/COLOR]', '', themeit=THEME3)
	addFile('  View Log'                        ,'viewlog',         icon=ICONMAINT, themeit=THEME1)
	addFile('  Upload Log'                      ,'uploadlog',       icon=ICONMAINT, themeit=THEME1)
	addFile('  View Wizard Log'                 ,'viewwizlog',      icon=ICONMAINT, themeit=THEME1)
	addFile('  Clear Wizard Log'                ,'clearwizlog',     icon=ICONMAINT, themeit=THEME1)
	addFile('  Clear Crash Logs'                ,'clearcrash',      icon=ICONMAINT, themeit=THEME1)
	addFile('[COLOR yellow][B][Add-Ons][/B][/COLOR]', '', themeit=THEME3)
	...
	addFile('[COLOR yellow][B][Misc][/B][/COLOR]', '', themeit=THEME3)
	addFile('  Force Close Kodi'                     ,'forceclose',      icon=ICONMAINT, themeit=THEME1)
	addFile('  Hide Passwords'   	                   ,'hidepassword',    icon=ICONMAINT, themeit=THEME1)
	addFile('  Unhide Passwords'                     ,'unhidepassword',  icon=ICONMAINT, themeit=THEME1)
	addFile('[COLOR yellow][B][Auto Clean][/B][/COLOR] ', '', fanart=FANART, icon=ICONMAINT, themeit=THEME3)
...
def saveMenu():
	...
	addFile('[COLOR yellow][B][Toggles][/B][/COLOR]', '', themeit=THEME3)
...
def clearCache():
	if DIALOG.yesno(ADDONTITLE, 'Clear Cache?', nolabel='Abort',yeslabel='Clear'):
		wiz.clearCache()

def clearThumb():
	if DIALOG.yesno(ADDONTITLE, "Would You Like To Delete The Thumbnails Folder?", "Restart Required!", nolabel='No, Abort',yeslabel='Yes, Remove'):
		shutil.rmtree(THDATA)
		wiz.killxbmc()
	else: wiz.log('Clear Thumbnails Aborted')
...
elif mode=='showcase'     : showcaseMenu()
